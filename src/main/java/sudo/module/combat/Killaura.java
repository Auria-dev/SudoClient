...
public class Killaura extends Mod {
	...
	public NumberSetting range = new NumberSetting("Range", 1, 6, 4, 0.1);
	public NumberSetting minAps = new NumberSetting("Min APS", 1, 20, 10, 1);
	public NumberSetting maxAps = new NumberSetting("Max APS", 1, 20, 15, 1);
	...
	public ColorSetting espColor = new ColorSetting("ESP Color", new Color(255, 0, 255));
	...
	public Killaura() {
		super("Killaura", "Attacks select surrounding entities", Category.COMBAT, 0);
		addSettings(mode, sortMode, rotation, range, minAps, maxAps, delay, random, swing, autoBlock, autoBlockMode, trigger, walls, players, animals, monsters, passives, invisibles, esp, espColor);
	}
